...
const TechnicalStatusSelect = (
    {project_id,
    completed,
    deliverable_id,
    deliverable_technical_situation}
) => {
    const [selectOption, setSelectOption] = useState(deliverable_technical_situation);
    const handleChange = (e) => {
        const technical_situation = e.target.value
        Swal.fire({
            ...
            if (result.isConfirmed) {         
                router.patch(
                    `/situation/projects/technical/store`,
                    { technical_situation: technical_situation, id: deliverable_id },
                    {
                        onSuccess:()=>{
                             Swal.fire({
                                title: "Éxito",
                            ...
                            setSelectOption(technical_situation)
                        }
                    }
                );
            }
...
export default function Index(props) {
    ...
    const handleSelecteChange = (e) => {
        if (e.target.value == "1") {
            router.visit(`/situation/projects/${project.id}/technical/1`);
        } else {
            router.visit(`/situation/projects/${project.id}/technical/0`);
        }
    };
            ...
            <div className="max-w-7xl px-4 mt-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto rounded-lg">
                    <h3 className="font-bold text-gray-600">
                        Estado Técnico de los entregables
                    </h3>
                                    ...
                                    {deliverables.map((deliverable, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-1 text-sm">
                                                <TechnicalStatusSelect project_id={project.id} deliverable_id={deliverable.id} deliverable_technical_situation={deliverable.technical_situation} completed={completed} />
                                            </td>
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                                <Link href={route("situation-section.project.technical.activity.index",{
