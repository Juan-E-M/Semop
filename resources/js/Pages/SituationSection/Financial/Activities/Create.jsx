...
export default function FinancialActivityCreate(props) {
    ...
    const submit = (e) => {
        ...
        post(route("situation-section.project.financial.activity.store"), {
            onSuccess: () => {
                Swal.fire({
                    ...
                    window.location.href = `/situation/projects/${project.id}/financial/${deliverable.id}/activity`;
                });
            },
        });
    };
                        ...
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                <p className="mt-5 text-sm leading-6 text-gray-600">
                                    Registrando actividad para entregable - {deliverable.denomination}
                                </p>
