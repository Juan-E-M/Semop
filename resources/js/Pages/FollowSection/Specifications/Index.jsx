...
export default function Index(props) {
    const { data: specifications, links } = usePage().props.specifications;
        ...
        >
            ...
            <div className="max-w-7xl px-4 mt-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto overflow-hidden rounded-lg">
                    ...
                    <Link
                        href={route("follow-section.project.specification.create", {
                                        ...
                                        >
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm ">
                                                <p className="text-gray-900 font-semibold whitespace-no-wrap">
                                                    {new Date(
                                                        specification.presentation_date
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                            <Link href={route("follow-section.project.specification.view",{
                                                    project_id:project.id,
