...
export default function SpecificationCreate(props) {
    const { project } = props;
    ...
    const submit = (e) => {
        ...
        post(route("follow-section.project.specification.store"), {
            onSuccess: () => {
                Swal.fire({
                    title: "Registro realizado",
                    text: "Especificación registrada",
                    icon: "success",
                }).then(() => {
                    window.location.href = `/follow/projects/${project.id}/specifications`;
                });
            },
        });
    };
                        ...
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                <p className="mt-5 text-sm leading-6 text-gray-600">
                                    Registrando especificación técnica
                                </p>
                                ...
                                <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                                    <div>
                                        <label
                                            htmlFor="start_et_date"
                                            className="block text-sm font-medium leading-6 text-gray-900"
                                        >
                                            Fecha de Inicio de ET
                                        </label>
                                        <div className="mt-2">
                                            <input
                                                required
