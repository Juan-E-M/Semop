...
export default function Index(props) {
    const { data: financial_entities, links } = usePage().props.financial_entities;
    ...
    return (
        ...
        >
            <Head title="Entidades Financieras" />
            ...
            <div className="max-w-7xl px-4 mt-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto overflow-hidden rounded-lg">
                    ...
                    <Link
                        href= {route('register-section.project.financial-entity.create',{
                    ...
                    {financial_entities == 0 ? (
                        ...
                        <>
                            <table className="w-full shadow border border-gray-300">
                                ...
                                <tbody>
                                    {financial_entities.map((financial_entity, i) => (
                                        <tr
                                            key={financial_entity.id}
                                        ...
                                        >
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                            <Link href={route("register-section.project.financial-entity.view",{
                                                    project_id:project.id,
                                                    financial_entity_id:financial_entity.id
