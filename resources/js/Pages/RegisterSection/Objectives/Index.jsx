...
export default function Index(props) {
    const { data: objectives, links } = usePage().props.objectives;
        ...
        >
            ...
            <div className="max-w-7xl px-4 mt-4 mx-auto sm:px-6 lg:px-8">
                <div className="mx-auto overflow-hidden rounded-lg">
                    ...
                    <Link
                        href= {route('register-section.project.objective.create',{
                                ...
                                <tbody>
                                    {objectives.map((objective, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                            <Link href={route("register-section.project.objective.view",{
                                                    project_id:project.id,
